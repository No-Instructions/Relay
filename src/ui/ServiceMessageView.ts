import { Component, ItemView, MarkdownRenderer, type Workspace, type WorkspaceLeaf, type ViewStateResult } from "obsidian";
...
export async function openServiceMessageView(workspace: Workspace, action: MarkdownAction): Promise<void> {
	...
	// Workspace.revealLeaf arrived in Obsidian 1.7.2; earlier versions focus the leaf instead.
