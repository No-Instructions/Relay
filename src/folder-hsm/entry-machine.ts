	...
	unclassified: {
		...
		on: {
			...
			CLASSIFY: [
				...
				// adopt. The confirmed-confidence bar is also what makes the
				// rebind reachable: confirmed confidence only ever arrives
				// with a live exchange, and the rebind needs the network.
				{
					target: "synced",
				...
				// competing, the rung above owns the path at confirmed
				// confidence and the hold rung below owns it before that,
