<script lang="ts">
	...
	const googleHelpText =
		"We use Google Sign-in to securely authenticate users and ensure only authorized team members can access shared folders. This helps protect your data and simplifies collaboration.";
